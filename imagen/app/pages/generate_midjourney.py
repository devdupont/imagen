...
# from imagen.log_factory import logger
# from imagen.streamlit.navbar import nav
# from imagen.streamlit.pages.common import display_image, missing_prompt_error, save_image
...
#             else:
#                 button_message_result = asyncio.run(message_processor(button_result.message_id))
#                 if isinstance(button_message_result, Error):
#                     st.error(f"Button message returned result: {button_message_result.error_message}")
#                 else:
...
#                     else:
#                         message_result = asyncio.run(message_processor(imagine_result.message_id))
#                         if isinstance(message_result, Error):
#                             st.error(f"Message for imagine call failed: {message_result.error_message}")
...
#     st.info(
#         "Please select buttons to select sub images or create new versions. If you want to stop, please press the 'Stop' button."
#     )
